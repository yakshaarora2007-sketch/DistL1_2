...
> Note: this repository calls models through OpenRouter using `evaluation_models.json`.
> You do not need Ollama to use this environment.

For a compact usage guide, see `USAGE.md`.
